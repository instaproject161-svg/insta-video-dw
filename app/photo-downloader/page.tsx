...
const config = DOWNLOADER_CONFIGS.photo;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://reelsave.app/photo-downloader" },
};
...
export default function Page() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: config.title,
            description: config.description,
            url: "https://reelsave.app/photo-downloader",
      ...
      />
      <DownloaderPageLayout type="photo" />
    </>
  );
}
