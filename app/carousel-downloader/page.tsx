...
const config = DOWNLOADER_CONFIGS.carousel;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://reelsave.app/carousel-downloader" },
};
...
export default function Page() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: config.title,
            description: config.description,
            url: "https://reelsave.app/carousel-downloader",
      ...
      />
      <DownloaderPageLayout type="carousel" />
    </>
  );
}
