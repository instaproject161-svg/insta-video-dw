...
const config = DOWNLOADER_CONFIGS.story;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://reelsave.app/story-downloader" },
};
...
export default function Page() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: config.title,
            description: config.description,
            url: "https://reelsave.app/story-downloader",
      ...
      />
      <DownloaderPageLayout type="story" />
    </>
  );
}
