...
const config = DOWNLOADER_CONFIGS.reels;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://reelsave.app/reels-downloader" },
};
...
export default function Page() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: config.title,
            description: config.description,
            url: "https://reelsave.app/reels-downloader",
      ...
      />
      <DownloaderPageLayout type="reels" />
    </>
  );
}
