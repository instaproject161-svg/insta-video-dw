...
const config = DOWNLOADER_CONFIGS.profile;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://reelsave.app/profile-picture-downloader" },
};
...
export default function Page() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: config.title,
            description: config.description,
            url: "https://reelsave.app/profile-picture-downloader",
      ...
      />
      <DownloaderPageLayout type="profile" />
    </>
  );
}
